    ...
    <table class="w-full min-w-[1250px] border-collapse text-sm">
        <thead>
            <tr class="bg-gray-200">
                ...
                <th class="border border-gray-400 px-3 py-2 text-left whitespace-nowrap">PR Created</th>
                <th class="border border-gray-400 px-3 py-2 text-left whitespace-nowrap">Date Needed</th>
        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-3 py-2 whitespace-nowrap">
                    {{ optional($purchaseRequest->created_at)->format('d F Y') ?? '-' }}
                </td>

                <td class="border border-gray-300 px-3 py-2 whitespace-nowrap">
                    {{ optional($purchaseRequest->date_needed)->format('d F Y') ?? '-' }}
                </td>
